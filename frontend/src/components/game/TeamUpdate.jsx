      ...
      <div className="team-update-container">
        <div className="input_box">
          ...
          <div className="button_group">
            ...
            <button className="input_btn btn-danger" onClick={deleteTeamMember}>팀 삭제</button>
            <button className="input_btn btn-danger" onClick={deleteIdMember}>조원 삭제</button>
          </div>
        </div>
            ...
            {list.map((detail) => (
              <div key={detail.id} className="member_item">
                ...
                <div style={{ display: "flex", gap: "8px", alignItems: "center" }}>
                  <span className="member_team">{detail.team}</span>
                  <span className="member_id">{detail.id}</span>
                </div>
              </div>
            ))}
          </div>
